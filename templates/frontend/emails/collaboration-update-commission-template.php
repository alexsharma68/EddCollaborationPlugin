...
<div class="saemail">
	<div class="saemailframe">
		...
		<div class="saemailbody">
			...
			<p><?php echo $CommissionAlert->Notification_From; ?> updated his commission in the workroom <b><?php echo $CommissionAlert->Workroom_Name; ?></b></p>

			<p>Please click on following link to see the updated commission:<br />
				<?php echo $CommissionAlert->Notification_Link; ?></p>

			<p>Regards,<br />
				<?php echo $CommissionAlert->Notification_From; ?>,<br/>
				ShareArts</p>
